...
namespace SAP_Core.DAL
{
    public class QuotaDAL : Connection, IDisposable
    {
        public ListQuotaBO GetQuotas(string CardCode, string SlpCode)
        {
            ...
            string strSQL = string.Format("CALL {0}.P_VIS_CALCULO_CUOTA_CABECERA ('{1}','{2}')", Utils.bd(), CardCode, SlpCode);
        ...
        public ListQuotaDetailBO GetQuotaDetail(string SlpCode, string CardCode)
        {
            ...
            string strSQL = string.Format("CALL {0}.P_VIS_SIS_TABLATEMP ('{1}','{2}')", Utils.bd(), SlpCode, CardCode);
        ...
        public ListQuotaInvoiceBO GetQuotaInvoice(string SlpCode, string CardCode)
        {
            ...
            string strSQL = string.Format("CALL {0}.P_VIS_CALCULO_CABECERA_CUOTA_FACTURA ('{1}','{2}')", Utils.bd(), SlpCode, CardCode);
