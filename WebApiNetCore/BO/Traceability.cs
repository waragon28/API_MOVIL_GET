...
namespace SAP_Core.BO
{
    ...
    public class SalesRouteBO
    {
        public string CardCode { get; set; }
        public string Address { get; set; }
        public string Chk_Visit { get; set; }
        public string Chk_Pedido{ get; set; }
        public string Chk_Cobranza { get; set; }
        public string Chk_Ruta { get; set; }
        public string FechaRuta { get; set; }
    }
    public class ListSalesRoute
    {
        public List<SalesRouteBO> SalesRoute { get; set; }
    }
}
