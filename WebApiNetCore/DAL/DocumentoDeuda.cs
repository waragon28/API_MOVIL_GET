...
namespace SAP_Core.DAL
{
    public class DocumentoDeudaDAL : Connection, IDisposable
    {
        public ListaDocumentoDeuda GetDocumentoDeuda(string imei)
        {
            ...
            string strSQL  = string.Format("CALL {0}.APP_INVOICES ('{1}')", DataSource.bd(), imei);
            ...
            catch (Exception ex)
            {
                ...
                strSQL = string.Format("CALL {0}.ins_msg_proc('{1}','{2}','{3}')", DataSource.bd(), "APP Sales Force GET", "Error", "Despacho_GetDocumentoDeuda - " + ex.Message+" "+
                    imei);
                HanaCommand command = new HanaCommand(strSQL, connection);
        ...
        public ListaDocumentoDeuda GetDocumentoDeudaCliente(string imei, string cliente)
        {
            ...
            List<DocumentoDeudaBO> listDocumentoDeuda = new List<DocumentoDeudaBO>();
            DocumentoDeudaBO documentoDeuda = new DocumentoDeudaBO();
            string strSQL = string.Format("CALL {0}.APP_INVOICES ('{1}','{2}')", DataSource.bd(), imei, cliente);
            ...
            catch (Exception ex)
            {
                ...
                strSQL = string.Format("CALL {0}.ins_msg_proc('{1}','{2}','{3}')", DataSource.bd(), "APP Sales Force GET", "Error", "Despacho_GetDocumentoDeudaCliente - " + ex.Message+" "+imei+" "+cliente);
                HanaCommand command = new HanaCommand(strSQL, connection);
        ...
        public List<DocumentoDeudaBO> GetDocumentoDeudaCliente2(string imei, string cliente)
        {
            ...
            catch (Exception ex)
            {
                ...
                strSQL = string.Format("CALL {0}.ins_msg_proc('{1}','{2}','{3}')", DataSource.bd(), "APP Sales Force GET", "Error", "Despacho_GetDocumentoDeudaCliente2 - " 
                    + ex.Message+" "+imei+" "+cliente);
                HanaCommand command = new HanaCommand(strSQL, connection);
